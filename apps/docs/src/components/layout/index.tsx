...
export function AppLayout() {
    return (
        <>
            <header className="flex-initial h-12 flex border-b items-center justify-between px-4">
                <div className="flex-initial flex justify-center items-center gap-2">
                    <svg
                        className="hidden text-foreground text-default-400"
                        fill="currentColor"
                        height="34"
                        viewBox="0 0 43 43"
                        width="34"
                    ...
                    <span className="text-2xl tracking-wide">ReactUI - Playground</span>
                </div>
            ...
            <section className="flex-1 flex w-full h-full overflow-hidden">
